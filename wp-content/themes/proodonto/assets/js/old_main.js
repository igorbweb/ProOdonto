 ...
 *
 * Qualquer clique num `a.cta` do site abre o modal em vez de navegar
 * direto pro href original (mantido como fallback: sem JS, o link
...
( function () {
	...
	var ctas = document.querySelectorAll( 'a.cta, [data-link-aggregator-trigger]' );
